...
class GlobalBenefitsScreen extends StatefulWidget {
  ...
  GlobalBenefitsScreen({super.key, required this.docid, required this.email});
                ...
                child: Column(
                  children: [
                    ...
                    _buildBoostOption(
                      ...
                      color: Colors.green,
                      onPressed: () => Admanager().showrewardedad(widget.docid),
                    ),
                    _buildBoostOption(
                      title: "1 Day – ₹19",
                      description:
    ...
    return RichText(
      ...
      text: TextSpan(
        ...
        children: [
          ...
          TextSpan(
            text:
                'What sets this feature apart is its adaptability. The Free global option operates solely when the Zizzle app is open, automatically disabling when closed. This nuanced approach gives users the flexibility to choose when their content receives global exposure, maintaining a balance between broad visibility and personal privacy.\n\n',
