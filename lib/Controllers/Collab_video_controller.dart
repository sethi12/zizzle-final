...
class CollabVideoController extends GetxController {
  String collabusername;
  String selectedvideoid;

  CollabVideoController(
      {required this.collabusername, required this.selectedvideoid});
  ...
  Stream<List<Video>> get videoListStream => _firestore
          .collection("reels")
          .where('collabusername', isEqualTo: collabusername)
          .snapshots()
